...
const Index = () => {
  ...
  const cars = [
    {
      ...
      price: '12 500 000',
      country: 'Япония',
      image: 'https://cdn.poehali.dev/projects/60ad9bb6-1987-4b85-907f-4721de88c35d/files/4aa915b8-a3b0-4e37-881c-b34c748ed7d0.jpg',
      mileage: '0 км',
      engine: '3.5 V6',
    },
    {
      ...
      price: '6 800 000',
      country: 'Корея',
      image: 'https://cdn.poehali.dev/projects/60ad9bb6-1987-4b85-907f-4721de88c35d/files/1c9fe206-8b3c-4b25-abec-d37f96d20c80.jpg',
      mileage: '0 км',
      engine: '2.5 Turbo',
    },
    {
      ...
      price: '5 200 000',
      country: 'Китай',
      image: 'https://cdn.poehali.dev/projects/60ad9bb6-1987-4b85-907f-4721de88c35d/files/87171d6b-28ca-419e-93a5-cfa8d0ba05c9.jpg',
      mileage: '0 км',
      engine: 'Электро',
    },
  ];
  ...
  const reviews = [
    {
      ...
      name: 'Александр М.',
      rating: 5,
      text: 'Приобрел Toyota Land Cruiser через Japan Export 27. Весь процесс занял 2 месяца, автомобиль доставлен в идеальном состоянии. Команда помогла с оформлением всех документов.',
      date: '15.12.2024',
    },
    {
      id: 2,
      name: 'Мария К.',
      rating: 5,
      text: 'Отличный сервис! Помогли подобрать Genesis G80 по моим требованиям. Все прозрачно, без скрытых платежей. Рекомендую!',
      date: '28.11.2024',
    },
    {
      id: 3,
      name: 'Дмитрий П.',
      rating: 5,
      text: 'Профессиональный подход к делу. Купил электромобиль BYD Tang. Сопровождали на всех этапах, от выбора до постановки на учет в ГИБДД.',
      date: '10.11.2024',
    },
  ];
  ...
  const brands = ['Все', 'Toyota', 'Hyundai', 'BYD'];
