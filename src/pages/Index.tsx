  ...
  const reviews = [
    {
      ...
      name: 'Алексей',
      rating: 5,
      text: 'Купил Toyota Camry. Всё быстро и понятно. Машина приехала через 2 месяца, состояние отличное. Спасибо!',
      date: '15.12.2024',
    },
    {
      id: 2,
      name: 'Ольга',
      rating: 5,
      text: 'Заказывала Hyundai Tucson. Ребята помогли с документами, всё объяснили. Довольна покупкой!',
      date: '28.11.2024',
    },
    {
      id: 3,
      name: 'Сергей',
      rating: 5,
      text: 'Взял RAV4 гибрид. Цена хорошая, доставка без проблем. Рекомендую!',
      date: '10.11.2024',
    },
  ];
